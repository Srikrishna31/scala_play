...
load("//third_party/scalactic:scalactic.bzl", "load_scalactic")
load("//third_party/scalatest:scalatest.bzl", "load_scalatest")
load("//third_party/scalatestplus_play:scalatestplus_play.bzl", "load_scalatestplus_play")
...
load("//third_party/selenium:selenium.bzl", "load_selenium")
